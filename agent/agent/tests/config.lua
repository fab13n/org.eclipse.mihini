...
function t:test_treemgr_getset1()
    ...
    u.assert_equal(v, tm.get"config.tests.getset1")
end
...
function t:test_treemgr_notify1()
    ...
    local r = tm.register("config.tests", notify)
...
function t:test_treemgr_notify2()
    ...
    sched.wait()
    u.assert_clone_tables({["config.tests.notify2.t2.3"]="c"}, vars)

    vars = nil
    tm.set("config.tests.notify2", nil)
    sched.wait()
    u.assert_clone_tables({["config.tests.notify2.t1"]=niltoken,
            ["config.tests.notify2.t2.1"]=niltoken,
            ["config.tests.notify2.t2.2"]=niltoken,
            ["config.tests.notify2.t2.3"]=niltoken}, vars)
...
function t:test_treemgr_notify3()
    ...
    sched.wait()
    u.assert_clone_tables({["config.tests.notify3.t1"]=42}, vars)
    ...
    sched.wait()
    u.assert_clone_tables({["config.tests.notify3.t1"]=niltoken}, vars)
